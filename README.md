...
| 🔍 **Semantic Search Platform** | Vector embeddings · keyword · hybrid RRF search · three-column comparison · SSE upload progress | FastAPI · Next.js · Qdrant · PostgreSQL | coming soon | [App ↗](https://semantic-search-frontend-j6yp.vercel.app/search) |
...
| ⚙️ **Task Automation API** | Async background jobs · status polling · progress tracking · JWT auth | FastAPI · Railway | [/docs ↗](https://task-automation-api-i90w.onrender.com/docs) | backend |
| 🌐 **Portfolio** | Technological Noir design · GSAP scroll reveals · custom cursor · contact API | Next.js · FastAPI · Framer Motion | [/docs ↗](#) | [fuadhaque.com ↗](https://fuadhaque.com) |
...
![Qdrant](https://img.shields.io/badge/Qdrant_Vector_DB-DC244C?style=for-the-badge&logo=qdrant&logoColor=white)
...
![HMAC](https://img.shields.io/badge/HMAC--SHA256-3C3C3D?style=for-the-badge&logo=letsencrypt&logoColor=white)
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Sora&weight=700&size=24&duration=2800&pause=1000&color=6C63FF&center=true&vCenter=true&width=700&lines=Full-Stack+Engineer+%7C+FastAPI+%C2%B7+Next.js;Real-time+Systems+%C2%B7+WebSocket+%C2%B7+SSE;Semantic+Search+%C2%B7+Vector+Embeddings+%C2%B7+Qdrant;Production+backends+and+the+UIs+that+ship+them.)](https://git.io/typing-svg)
...
I build **production FastAPI backends** and the **Next.js interfaces that make them shippable.**<br/>
Webhook pipelines · Real-time systems · Async task queues · AI-powered semantic search — deployed, documented, and delivered with Swagger docs and a live `/health` endpoint on day one.
...
<div align="center">
  ...
  <a href="https://fuadhaque.com/services">
    <img src="https://img.shields.io/badge/Services-fuadhaque.com%2Fservices-6C63FF?style=for-the-badge&logo=vercel&logoColor=white" />
  </a>
  <a href="https://cal.com/fuad-haque/30min">
    <img src="https://img.shields.io/badge/Book_a_Call-30_Minutes-292929?style=for-the-badge&logo=calendly&logoColor=white" />
  </a>
</div>
...
<details>
<summary><b>Why Semantic Search Outperforms Keyword Search</b></summary>

<br/>

| Query | Keyword Search | Semantic Search |
|-------|---------------|-----------------|
| `"invoice"` | Returns documents containing the exact word "invoice" | Returns documents about billing, payments, and receipts |
| `"slow response"` | Returns documents with "slow response" literally | Returns documents about latency, performance, and timeouts |
| `"how do I cancel"` | Returns documents with that exact phrase | Returns cancellation policy, refund process, account deletion |
| `"Python async code"` | Exact match only | Returns asyncio, coroutines, await patterns |

**Result:** Semantic search finds what users *mean*, not just what they *typed.*<br/>
Built with sentence-transformers + Qdrant + PostgreSQL FTS + Reciprocal Rank Fusion.
