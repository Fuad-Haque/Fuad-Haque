...
| **Semantic Search** | Vector embeddings · Qdrant · hybrid search · deployed
...
**Result:** Semantic search finds what users *mean*, not just what they *typed.*  
Built with `sentence-transformers/all-MiniLM-L6-v2` · Qdrant vector database · PostgreSQL full-text search · Reciprocal Rank Fusion.
